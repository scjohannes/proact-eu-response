# ============================================================================
# Continue Simulation 3. 30.12.2025. Sample size 600 and 800
# ============================================================================
...
SAMPLE_SIZE <- c(600, 800) # Patients per sample. Run 1000 in a separate file.
...
final_seed_path <- "seed_after_initial_run30_12_25_continued.rds"
results_prefix <- "simulation_results_301225_continued" # es_label and ss_label will be added
details_folder_prefix <- "continued_scenario"
...
available_effect_sizes <- available_effect_sizes[c(7)]
...
# Set master seed
.Random.seed <- readRDS("seed_after_initial_run30_12_25.rds")
...
for (j in seq_along(SAMPLE_SIZE)) {
  for (i in seq_along(available_effect_sizes)) {
    ...
    DETAILS_PATH <- path(
      OUTPUT_PATH,
      paste0(details_folder_prefix, es_label, "_", ss_label)
    )
