...
#OUTPUT_PATH1 <- "/home/felix/SHARE/imssrv_home/Simulations/EUPROACT Simulations/proact-sim/scripts/output/sim301225"
OUTPUT_PATH1 <- "/home/felix/Simulations/EUPROACT Simulations/proact-sim/scripts/output/sim301225"
...
plotH0 <- ggplot(subset(summary_HA, effect_size == 0.05), 
                 aes(x = sample_size, y = power, color = analysis)) +
  geom_point() +
  geom_line() +
  facet_wrap(~effect_size) + 
