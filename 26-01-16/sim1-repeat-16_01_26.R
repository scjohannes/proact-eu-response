# ============================================================================
# Simulation 1.1. 16.01.2025. 
# ============================================================================

# Superpopulations from 05.12.25 are used, and the simulations repeated using the 
# latest simulation pipelines to check consistency. 
...
# File paths ----
OUTPUT_PATH <- here("scripts", "output", "sim160126")
DATA_PATH <- here("scripts", "data")
final_seed_path <- "seed_after_initial_run16_01_26.rds"
results_prefix <- "simulation_results_160126" # es_label and ss_label will be added
...
available_effect_sizes <- available_effect_sizes[c(#1, 
  2, 4, 6)]
